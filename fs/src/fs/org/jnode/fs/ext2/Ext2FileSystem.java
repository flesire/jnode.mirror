/*
 * $Id: Ext2FileSystem.java 5962 2013-02-19 16:26:07Z galatnm $
 *
...
public class Ext2FileSystem extends AbstractFileSystem<Ext2Entry> {
	...
	public BlockReservation testAndSetBlock(long blockNr) throws IOException {
		...
		if (blockNr < superblock.getFirstDataBlock() || blockNr >= superblock.getBlocksCount()) return new BlockReservation(
				false, -1, -1);
