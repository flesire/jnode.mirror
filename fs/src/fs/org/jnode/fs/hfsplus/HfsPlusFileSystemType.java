...
public class HfsPlusFileSystemType implements BlockDeviceFileSystemType<HfsPlusFileSystem> {
    ...
    public final boolean supports(final PartitionTableEntry pte, final byte[] firstSector,
        ...
        /*
         * if (pte != null) { if (pte instanceof IBMPartitionTableEntry) { if
         * (((IBMPartitionTableEntry) pte).getSystemIndicator() !=
         * IBMPartitionTypes.PARTTYPE_LINUXNATIVE) { return false; } } }
         */
        ...
        return (magicNumber == VolumeHeader.HFSPLUS_SUPER_MAGIC && version == 4) ||
                (magicNumber == VolumeHeader.HFSX_SUPER_MAGIC && version == 5);
    }
