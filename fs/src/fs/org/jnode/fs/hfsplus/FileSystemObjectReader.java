...
public class FileSystemObjectReader {
    ...
    public static Catalog readCatalog(HfsPlusFileSystem fs) throws IOException {
        ...
        NodeDescriptor descriptor =
                new NodeDescriptor(readForkData(fs, catalogFork, 0,
                        NodeDescriptor.BT_NODE_DESCRIPTOR_LENGTH), 0);
        // Read header record
        BTHeaderRecord headerRecord =
                new BTHeaderRecord(readForkData(fs, catalogFork,
    ...
    public static Catalog createCatalog(HfsPlusFileSystem fs, HFSPlusParams params)
        throws IOException {
     ...
     * @throws IOException
     */
    public static void writeCatalog(HfsPlusFileSystem fs, Catalog catalog, CatalogLeafNode rootNode)
        throws IOException {
    ...
    public static Extent readExtent(HfsPlusFileSystem fs) throws IOException {
        ...
        // read node descriptor
        NodeDescriptor descriptor =
                new NodeDescriptor(readForkData(fs, extentFork, 0,
                        NodeDescriptor.BT_NODE_DESCRIPTOR_LENGTH), 0);
        // Read header record
        BTHeaderRecord headerRecord =
                new BTHeaderRecord(readForkData(fs, extentFork, 0,
                        BTHeaderRecord.BT_HEADER_RECORD_LENGTH), 0);
        // Construct catalog
    ...
    public static ByteBuffer readForkData(HfsPlusFileSystem fs, HfsPlusForkData data, int offset,
