/*
 * $Id: KeyboardInterpreter_ES.java 5956 2013-02-17 20:50:10Z lsantha $
 *
...
public class KeyboardInterpreter_ES extends AbstractKeyboardInterpreter {
    ...
    /**
     * todo correct the keys acorrding to old protected void
     * todo initVkMap(int[] vkMap, char[] lcharMap, char[] ucharMap,char[] altGrCharMap) {
     *
     * @param keys
     */
