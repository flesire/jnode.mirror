...
public interface EthernetConstants {
    ...
    public static final int ETH_FRAME_LEN = 1514; /*
                                                   * Max. octets in frame sans
                                                   * FCS
                                                   */
    ...
    public static final int ETH_P_BPQ = 0x08FF; /*
                                                 * G8BPQ AX.25 Ethernet Packet [
                                                 * NOT REGISTERED ]
                                                 */
    public static final int ETH_P_IEEEPUP = 0x0a00; /*
                                                     * Xerox IEEE802.3 PUP
                                                     * packet
                                                     */
    public static final int ETH_P_IEEEPUPAT = 0x0a01; /*
                                                       * Xerox IEEE802.3 PUP
                                                       * Addr Trans packet
                                                       */
    ...
    public static final int ETH_P_ATMFATE = 0x8884; /*
    ...
    public static final int ETH_P_WAN_PPP = 0x0007; /*
                                                     * Dummy type for WAN PPP
                                                     * frames
                                                     */
    public static final int ETH_P_PPP_MP = 0x0008; /*
                                                    * Dummy type for PPP MP
                                                    * frames
                                                    */
    public static final int ETH_P_LOCALTALK = 0x0009; /* Localtalk pseudo type */
    public static final int ETH_P_PPPTALK = 0x0010; /*
                                                     * Dummy type for Atalk over
                                                     * PPP
                                                     */
    ...
    public static final int ETH_P_CONTROL = 0x0016; /*
