...
public class NFS2Exception extends Exception {
    ...
    public static String getNFSMessage(ResultCode resultCode) {
        ...
        if (resultCode == ResultCode.NFS_ERROR_NO_PERM) {
            ...
            text =
                    "Permission denied.  The caller does not have the correct permission to perform "
            ...
            text =
                    "The 'fhandle' given in the arguments was invalid.  That is, the file referred to by "
