...
public class IPv4Statistics implements Statistics {
    ...
    protected final Counter badhlen = new Counter("badhlen",
            "#received packets with invalid IP header length");
    ...
    protected final Counter badvers = new Counter("badvers",
            "#received packets with an IP version other then 4");
    ...
    protected final Counter noproto = new Counter("noproto",
            "#received packets with an unknown or unsupported protocol");
    protected final Counter nodevaddr = new Counter("nodevaddr",
            "#received packets not delivered because device address was not set");
    ...
    private final Counter[] list = new Counter[] {badhlen, badlen, badsum, fragments, ipackets,
        noproto, nodevaddr, opackets};
