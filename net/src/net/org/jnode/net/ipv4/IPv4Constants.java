...
public interface IPv4Constants {
    ...
    public static final int IP_FRAGOFS_MASK = 0x1FFF; /*
                                                       * Mask to get fragment
                                                       * offset
                                                       */

    public static final long IP_FRAGTIMEOUT = 120000; /*
                                                       * Number of ms till a
                                                       * fragment list is timed
                                                       * out.
                                                       */
    ...
    public static final int RTF_REINSTATE = 0x0008; /*
                                                     * reinstate route after
                                                     * timeout
                                                     */
    public static final int RTF_DYNAMIC = 0x0010; /* created dyn. (by redirect) */
    public static final int RTF_MODIFIED = 0x0020; /*
                                                    * modified dyn. (by
                                                    * redirect)
                                                    */
    ...
    public static final int NETWORK_CLASSA = 128; /*
                                                   * 0.0.0.0 - 127.255.255.255
                                                   * x.0.0.0 255.0.0.0
                                                   */
    public static final int NETWORK_CLASSB = 192; /*
                                                   * 128.0.0.0 - 191.255.255.255
                                                   * x.x.0.0 255.255.0.0
                                                   */
    public static final int NETWORK_CLASSC = 224; /*
