...
public interface Prism2Constants {
    ...
    public enum Register {
        CMD(0x00), PARAM0(0x04), PARAM1(0x08), PARAM2(0x0c), STATUS(0x10), RESP0(0x14), RESP1(0x18), RESP2(
                0x1c), INFOFID(0x20), RXFID(0x40), ALLOCFID(0x44), TXCOMPLFID(0x48), SELECT0(0x30), OFFSET0(
                0x38), DATA0(0x6c), SELECT1(0x34), REGSET1(0x3c), DATA1(0x70), EVSTAT(0x60), INTEN(
                0x64), EVACK(0x68), CONTROL(0x28), SWSUPPORT0(0x50), SWSUPPORT1(0x54), SWSUPPORT2(
                0x58), AUXPAGE(0x74), AUXOFFSET(0x78), AUXDATA(0x7c), PCICOR(0x4c), PCIHCR(0x5c), PCI_M0_ADDRH(
                0x80), PCI_M0_ADDRL(0x84), PCI_M0_LEN(0x88), PCI_M0_CTL(0x8c), PCI_STATUS(0x98), PCI_M1_ADDRH(
    ...
    public static final int CMD_AINFO = 0x4000 | 0x2000 | 0x1000 | 0x0800 | 0x0400 | 0x0200 |
            0x0100;;
    ...
    public static final int STATUS_RESULT = 0x4000 | 0x2000 | 0x1000 | 0x0800 | 0x0400 | 0x0200 |
            0x0100;
    ...
    public static final int OFFSET_DATAOFF = 0x0800 | 0x0400 | 0x0200 | 0x0100 | 0x80 | 0x40 |
    ...
    public enum RecordID {
        /*--------------------------------------------------------------------
         ...
         --------------------------------------------------------------------*/
        CNFPORTTYPE(0xFC00, 2), CNFOWNMACADDR(0xFC01, 6), CNFDESIREDSSID(0xFC02, 34), CNFOWNCHANNEL(
                0xFC03, 2), CNFOWNSSID(0xFC04, 34), CNFOWNATIMWIN(0xFC05, 2), CNFSYSSCALE(0xFC06), CNFMAXDATALEN(
                0xFC07), CNFWDSADDR(0xFC08, 6), CNFPMENABLED(0xFC09), CNFPMEPS(0xFC0A), CNFMULTICASTRX(
                0xFC0B), CNFMAXSLEEPDUR(0xFC0C), CNFPMHOLDDUR(0xFC0D), CNFOWNNAME(0xFC0E), CNFOWNDTIMPER(
                0xFC10), CNFWDSADDR1(0xFC11), CNFWDSADDR2(0xFC12), CNFWDSADDR3(0xFC13), CNFWDSADDR4(
                0xFC14), CNFWDSADDR5(0xFC15), CNFWDSADDR6(0xFC16), CNFMCASTPMBUFF(0xFC17),

        /*--------------------------------------------------------------------
         Configuration RIDs: Network Parameters, Dynamic Configuration Entities
         --------------------------------------------------------------------*/
        GROUPADDR(0xFC80), CREATEIBSS(0xFC81), FRAGTHRESH(0xFC82), RTSTHRESH(0xFC83), TXRATECNTL(
                0xFC84), PROMISCMODE(0xFC85), FRAGTHRESH0(0xFC90), FRAGTHRESH1(0xFC91), FRAGTHRESH2(
                0xFC92), FRAGTHRESH3(0xFC93), FRAGTHRESH4(0xFC94), FRAGTHRESH5(0xFC95), FRAGTHRESH6(
                0xFC96), RTSTHRESH0(0xFC97), RTSTHRESH1(0xFC98), RTSTHRESH2(0xFC99), RTSTHRESH3(
                0xFC9A), RTSTHRESH4(0xFC9B), RTSTHRESH5(0xFC9C), RTSTHRESH6(0xFC9D), TXRATECNTL0(
                0xFC9E), TXRATECNTL1(0xFC9F), TXRATECNTL2(0xFCA0), TXRATECNTL3(0xFCA1), TXRATECNTL4(
                0xFCA2), TXRATECNTL5(0xFCA3), TXRATECNTL6(0xFCA4),

        /*--------------------------------------------------------------------
         API ENHANCEMENTS (NOT ALREADY IMPLEMENTED)
         --------------------------------------------------------------------*/
        CNFWEPDEFAULTKEYID(0xFC23), CNFWEPDEFAULTKEY0(0xFC24), CNFWEPDEFAULTKEY1(0xFC25), CNFWEPDEFAULTKEY2(
                0xFC26), CNFWEPDEFAULTKEY3(0xFC27), CNFWEPFLAGS(0xFC28), CNFWEPKEYMAPTABLE(0xFC29), CNFAUTHENTICATION(
                0xFC2A), CNFMAXASSOCSTATIONS(0xFC2B), CNFTXCONTROL(0xFC2C), CNFROAMINGMODE(0xFC2D), CNFHOSTAUTH(
                0xFC2E), CNFRCVCRCERROR(0xFC30), CNFMMLIFE(0xFC31), CNFALTRETRYCNT(0xFC32), CNFAPBCNINT(
                0xFC33), CNFAPPCFINFO(0xFC34), CNFSTAPCFINFO(0xFC35), CNFPRIORITYQUSAGE(0xFC37), CNFTIMCTRL(
                0xFC40), CNFTHIRTY2TALLY(0xFC42), CNFENHSECURITY(0xFC43), CNFDBMADJUST(0xFC46), // NEW
        CNFSHORTPREAMBLE(0xFCB0), CNFEXCLONGPREAMBLE(0xFCB1), CNFAUTHRSPTIMEOUT(0xFCB2), CNFBASICRATES(
                0xFCB3), CNFSUPPRATES(0xFCB4), CNFFALLBACKCTRL(0xFCB5), // NEW
        ...
        /*----------------------------------------------------------------------
         ...
         --------------------------------------------------------------------*/
        MAXLOADTIME(0xFD00), DOWNLOADBUFFER(0xFD01), PRIIDENTITY(0xFD02), PRISUPRANGE(0xFD03), PRI_CFIACTRANGES(
                0xFD04), NICSERIALNUMBER(0xFD0A), NICIDENTITY(0xFD0B), MFISUPRANGE(0xFD0C), CFISUPRANGE(
                0xFD0D), CHANNELLIST(0xFD10), REGULATORYDOMAINS(0xFD11), TEMPTYPE(0xFD12), CIS(
                0xFD13), STAIDENTITY(0xFD20), STASUPRANGE(0xFD21), STA_MFIACTRANGES(0xFD22), STA_CFIACTRANGES(
                0xFD23), BUILDSEQ(0xFFFE), FWID(0xFFFF),

        /*--------------------------------------------------------------------
         Information RIDs:  MAC Information
         --------------------------------------------------------------------*/
        PORTSTATUS(0xFD40), CURRENTSSID(0xFD41), CURRENTBSSID(0xFD42), COMMSQUALITY(0xFD43), CURRENTTXRATE(
                0xFD44), CURRENTBCNINT(0xFD45), CURRENTSCALETHRESH(0xFD46), PROTOCOLRSPTIME(0xFD47), SHORTRETRYLIMIT(
                0xFD48), LONGRETRYLIMIT(0xFD49), MAXTXLIFETIME(0xFD4A), MAXRXLIFETIME(0xFD4B), CFPOLLABLE(
                0xFD4C), AUTHALGORITHMS(0xFD4D), PRIVACYOPTIMP(0xFD4F), DBMCOMMSQUALITY(0xFD51), CURRENTTXRATE1(
                0xFD80), CURRENTTXRATE2(0xFD81), CURRENTTXRATE3(0xFD82), CURRENTTXRATE4(0xFD83), CURRENTTXRATE5(
                0xFD84), CURRENTTXRATE6(0xFD85), OWNMACADDRESS(0xFD86), PCFINFO(0xFD87), SCANRESULTS(
                0xFD88), // NEW
        ...
        /*--------------------------------------------------------------------
         ...
         --------------------------------------------------------------------*/
        PHYTYPE(0xFDC0), CURRENTCHANNEL(0xFDC1), CURRENTPOWERSTATE(0xFDC2), CCAMODE(0xFDC3), SUPPORTEDDATARATES(
                0xFDC6);
    ...
    public enum InformationType {
        HANDOVERADDR(0xF000), COMMTALLIES(0xF100), SCANRESULTS(0xF101), CHINFORESULTS(0xF102), HOSTSCANRESULTS(
                0xF103), LINKSTATUS(0xF200), ASSOCSTATUS(0xF201), AUTHREQ(0xF202), PSUSERCNT(0xF203), KEYIDCHANGED(
                0xF204);
    ...
    public enum LinkStatus {
        NOTCONNECTED(0), CONNECTED(1), DISCONNECTED(2), AP_CHANGE(3), AP_OUTOFRANGE(4), AP_INRANGE(
                5), ASSOCFAIL(6);
